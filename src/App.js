...
import PosGraph from './components/PosGraph';
import PTimeGraph from './components/PTimeGraph';
        ...
        <section className="container-fluid">
          <div className="row">
            <div className="col-sm-12">
              <PosGraph data={this.state.data} />
            </div>
          </div>
          <div className="row">
            <div className="col-sm-12">
              <PTimeGraph data={this.state.data} />
            </div>
          </div>
          <div className="row">
            <div className="col-sm-12">
              <VolumeGraph data={this.state.data} />
            </div>
          </div>
        </section>
      </>
